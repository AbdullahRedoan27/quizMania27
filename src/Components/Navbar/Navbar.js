    ...
    return (
        <nav className='lg:flex lg:justify-around md:flex md:justify-around flex justify-between bg-slate-700 text-white md:p-16 lg:p-8 p-6'>
            <div className="flex items-center">
                ...
                <h1 className='text-xl md:text-2xl font-semibold lg:ml-2'>Quiz Mania</h1>
            </div>


            <div className='relative'>
                <div className={`flex flex-col md:flex md:flex-col lg:flex lg:flex-row absolute lg:static duration-500 ease-in ease-out ${rise ? 'top-[-20px] right-12' : 'top-[-180px]'}`} >
